    ...
    {details ? (
       ...
       tavsiya etamiz. Katta va kichik o'lchamlar.
        ...
        <div className="flex flex-col justify-center items-center gap-3">
            ...
            <h1 className="text-xl font-medium">Mahsulot tavsiri hali qoshilmadi</h1>
            <p className="text-sm">Mahsulot qoshilmaganligi sababini bilish uchun operator bilan boxlanishingiz mumkin</p>
        </div>
    )}
